    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-slate-400 mt-2">Start your officiating journey</p>
        </div>
        ...
        <div className="bg-white/10 backdrop-blur-xl rounded-2xl border border-white/20 p-8">
          ...
          <button
            ...
            disabled={loading}
            className="w-full py-3 bg-white hover:bg-slate-100 text-slate-900 font-semibold rounded-lg transition flex items-center justify-center gap-3 disabled:opacity-50 disabled:cursor-not-allowed"
          >
